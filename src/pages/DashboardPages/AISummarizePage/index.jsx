...
const AISummarizePage = () => {
  ...
  const handleSendMessage = useCallback(async () => {
    ...
    const customCallback = (token, fullText) => {
      setLastSummary(fullText);
    };

    await sendMessage(null, (content, sessionId, onTokenReceived) => {
      return api.chatbot.documentationSummarize(content, sessionId, (token, fullText) => {
