 ...
 */
const ClinicInfoWindow = React.memo(({ clinic, isMobile }) => {
      ...
      {clinic.phoneNumber && (
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
          ...
          <Link
            component="button"
            variant="body2"
            onClick={() => handlePhoneClick(clinic.phoneNumber)}
            sx={{ 
              fontSize: { xs: '0.8rem', sm: '0.875rem' },
              textAlign: 'left',
              color: 'primary.main',
      ...
      {clinic.email && (
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
          ...
          <Link
            component="button"
            variant="body2"
            onClick={() => handleEmailClick(clinic.email)}
            sx={{ 
              fontSize: { xs: '0.8rem', sm: '0.875rem' },
              textAlign: 'left',
              color: 'primary.main',
